...
public class MenuItems {
	...
	ControllButton buttonFastForward;

	public MenuItems() {
		buttonFastBackward= new ControllButton();
		buttonBackward	  = new ControllButton();
		buttonForward	  = new ControllButton();
		buttonFastForward = new ControllButton();
	}
	...
	public void drawTriangle(Graphics g, ControllButton lineButton, int x1, int y1, int x2, int y2, int x3, int y3) {
		g.setColor(java.awt.Color.BLACK);
		x1=convertCoordinate(x1, lineButton.x0, lineButton.xSize);
		y1=convertCoordinate(y1, lineButton.y0, lineButton.ySize);
		x2=convertCoordinate(x2, lineButton.x0, lineButton.xSize);
	...
	public void button1(Graphics g, ControllButton button1, int x0, int y0, int xSize, int ySize, int bID) {
		button1.x0		 = x0;
		button1.y0		 = y0;
		button1.xSize	 = xSize;
		button1.ySize	 = ySize;
